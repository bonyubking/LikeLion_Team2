package com.exam;
// 의존성 주입 -> 결합도 약하게 -> 패턴을 느슨하게 만들었다 
// 1. 인터페이스를 지정해서 추상화, 
// 2. 생성자를 통해 필요한 의존성(InputDevice, Display)을 주입 -> 객체를 직접 생성하지 않는다
// 3. 각 메소드 구현시 편하게 호출이 가능하다 
...
public class ComputerDI {
    ...
    // 생성자를 통해 필요한 의존성(InputDevice, Display)을 주입-> 의존성이 낮다 
