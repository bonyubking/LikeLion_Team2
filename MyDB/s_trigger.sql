...
BEGIN
    IF NEW.SAL <> OLD.SAL THEN
		...
		INSERT INTO EMP_UPDATE_LOG (EMPNO, OLD_SAL, NEW_SAL, CHANGED_AT)
...
INSERT INTO EMP(EMPNO, ENAME, SAL, DEPTNO) VALUES (3, "홍길동", 1000, NULL);
SELECT *
FROM EMP_LOG;

SELECT * FROM INFORMATION_SCHEMA.TRIGGERS
	WHERE TRIGGER_SCHEMA ='MY_EMP' AND TRIGGER_NAME = 'AFTER_EMP_INSERT';
...
UPDATE EMP SET SAL = 10010 WHERE EMP.EMPNO = 7369;
  -- 업데이트 실행 
SELECT  * FROM EMP_UPDATE_LOG;   -- 확인 


-- EMP에서 AFTER_EMP_DELETE 작성
DELIMITER //
