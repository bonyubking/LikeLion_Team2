...
CREATE USER 'new_TEST'@'%' IDENTIFIED BY 'new_Test';           -- 네트워크 접근 가능 사용자

-- 권한 부여
GRANT ALL PRIVILEGES ON my_emp.* TO 'new_user'@'localhost';
GRANT ALL PRIVILEGES ON my_emp.* TO 'new_Test'@'%';          -- 특정 데이터베이스에 대한 권한 부여
