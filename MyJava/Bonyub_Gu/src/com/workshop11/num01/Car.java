...
public class Car extends Vehicle {
	...
	public void moving(int distance) {
		restOil -= distance / this.getEfficiency();
		if (restOil < 0) {
			restOil = 0;
		}
	}
	...
	public String toString() {
		return super.toString() + String.format("%5.1f %5d", restOil, curWeight);
	}
