...
public class d_ifTest {
	...
	public static void checkPassOrFail(int score, boolean isPassed) {
		...
		// score가 80 이상이고 isPassed true이고 score가 홀수인 경우
	...
	public static void checkEligibility(int age, String country) {
		...
		// age가 18세 이상 30세 이하이거나 country가 korea인 경우는 조건을 충족한다
	...
	// 3. 객체 유형과 조건을 조합한 경우
	// 가장 상위 부모 타입을 선언하게 되면 모든 class는 대입된다
	// String -> Object -> (String)obj로 형변환됨
	public static void checkStringLength(Object obj) {
		// instanceof : 객체 타입을 확인하는 연산자
		// obj가 String 클래스의 인스턴스이고, 문자열의 길이가 5보다 큰 경우만 메세지 출력
	...
	public static void checkEvenPositive(int num) {
		// 삼항 연산자 조건식 ? true명령 : false명령 
		// num이 2의 배수면 true, 그렇지 않으면 false를 isEven에 대입
		boolean isEven = (num % 2 == 0) ? true : false;
		
		//num이 0보다 크면 양수를 result에 대입하고 그렇지 않으면 음수 또는 0을 대입
