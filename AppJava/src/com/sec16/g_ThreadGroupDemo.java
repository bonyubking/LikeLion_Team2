...
public class g_ThreadGroupDemo {
    public static void main(String[] args) {
        ...
        // 3. 그룹에 속한 스레드 생성
        Thread t1 = new Thread(parent_group, task, "ParentThread");
        Thread t2 = new Thread(child_group, task, "ChildThread");
        ...
        System.out.println("자식 활성 스레드 수: " + child_group.activeCount()+" ----> " + child_group.getParent());
        child_group.list();
    }
}