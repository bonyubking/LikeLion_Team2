...
//Person 객체 배열을  Comparable 

import java.util.Arrays;
import java.util.Comparator;

public class Person implements Comparable<Person>{//제네릭 타입을 명시<T>
   ...
   //this.id - m_p.id 결과가 양수이면 this가 더 크고 음수면 this가 더 작다 
   @Override
   public int compareTo(Person m_p) {      
       return (this.id - m_p.id); //현재 객체 this와 비교대상 m_p의 id 값 비교 
   }
