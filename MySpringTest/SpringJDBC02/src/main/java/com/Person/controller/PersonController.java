...
public class PersonController {
	...
	private final PersonServiceImple service;
	private final PersonColsolView view;
	private final Scanner sc = new Scanner(System.in);
	
	@Autowired
	public PersonController(PersonService service, PersonColsolView view) {
		this.service = (PersonServiceImple) service;
		this.view = view;
	}
