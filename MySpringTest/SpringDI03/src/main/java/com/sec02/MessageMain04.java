...
public class MessageMain04 {
    public static void main(String[] args) throws IOException {
        ...
        // 빈으로 등록된 리소스 접근
        Resource myResourceBean = context.getBean("myResource", Resource.class);
        System.out.println("\n빈으로 등록된 리소스: " + myResourceBean.getDescription());
        if (myResourceBean.exists()) {
            InputStream inputStream = myResourceBean.getInputStream();
            String content = new String(inputStream.readAllBytes(), StandardCharsets.UTF_8);
